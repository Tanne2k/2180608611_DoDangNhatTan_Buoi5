...
public class ProductController {
    ...
    @PostMapping("/add")
    public String addProduct(@Valid Product product, BindingResult result, @RequestParam("avatarFiles") List<MultipartFile> avatarFiles) {
        if (result.hasErrors()) {
            return "/products/add-product";
        }
    ...
    public String updateProduct(@PathVariable Long id, @Valid Product product,
                                ...
                                @RequestParam("avatarFiles") List<MultipartFile> avatarFiles) {
        if (result.hasErrors()) {
